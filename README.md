...
معمولاً aggregate از طریق انتقال وضعیت صریح می گذرد، که بر نحوه تعامل با آن تأثیر می گذارد.انتقال بسیار خام / ساده ممکن است نشان دهد که aggregate ضعیف است و منطق به سمت سرویس‌ها سوق داده شد.در این بخش از بوم وضعیت های ممکن را فهرست کنید یا یک نمودار انتقال کوچک رسم کنید.
...
![نمودار ارزیابی شانس تضاد همزمانی Aggregate](resources/aggregate-concurency-conflict-chance-evaluation-chart-farsi.png "نمودار ارزیابی شانس تضاد همزمانی Aggregate")
...
![نمودار ارزیابی اندازه Aggregate](resources/aggregate-size-evaluation-chart-farsi.png "نمودار ارزیابی اندازه Aggregate")
